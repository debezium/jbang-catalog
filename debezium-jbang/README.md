...
```shell
jbang alias add --name debezium -Ddebezium.jbang.version=3.7.0-SNAPSHOT ./debezium-jbang/debezium-jbang-main/dist/DebeziumJBang.java

jbang debezium version  
Debezium JBang version: 3.7.0-SNAPSHOT
```