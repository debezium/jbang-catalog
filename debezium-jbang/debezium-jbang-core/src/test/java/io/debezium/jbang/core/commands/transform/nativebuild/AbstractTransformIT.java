...
abstract class AbstractTransformIT extends NativeTestPicoCliCommand {
    ...
    protected String executeTransform(String subCommand) {
        return execute("transform " + subCommand + " --platform-address " + apiUrl());
    }

    protected String transformYaml(String name) {
        return "name: " + name + "\ndescription: test transform\ntype: filter\nschema: io.debezium.transforms.Filter\nconfig: {}\n";
    }
}
