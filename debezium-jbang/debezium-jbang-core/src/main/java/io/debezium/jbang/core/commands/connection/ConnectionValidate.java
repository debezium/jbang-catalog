...
@CommandLine.Command(name = "validate", description = "Validate a connection config from a YAML file", sortOptions = false)
public class ConnectionValidate extends DebeziumCommand {
    ...
    public ConnectionValidate(DebeziumJBangMain main) {
        super(main);
    }
    ...
    public Integer doCall() throws Exception {
        ...
        ConnectionValidationResult result = connectionService.validateConnection(request);
        ...
        println("Connection is invalid: " + result.message());
        return 1;
    }
}
